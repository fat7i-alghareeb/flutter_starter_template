...
class AppStrings {
  ...
  /// You are not authorized. Please sign in again. - غير مصرح. يرجى تسجيل الدخول مرة أخرى.
  static String get authUnauthorized => 'authUnauthorized'.tr();

  /// The request was invalid. - الطلب غير صالح.
  static String get clientBadRequest => 'clientBadRequest'.tr();

  /// A conflict occurred. Please try again. - حدث تعارض. حاول مرة أخرى.
  ...
  /// The data you sent could not be processed. - لا يمكن معالجة البيانات المرسلة.
  static String get clientUnprocessableEntity =>
      'clientUnprocessableEntity'.tr();

  /// Failed to process server response. - فشل في معالجة استجابة الخادم.
  static String get decodeError => 'decodeError'.tr();

  /// A network security error occurred. - حدث خطأ في أمان الشبكة.
  static String get networkCertificateError => 'networkCertificateError'.tr();

  /// Unable to connect to the server. Please try again. - تعذر الاتصال بالخادم. حاول مرة أخرى.
  ...
  /// The request timed out. Please try again. - انتهت مهلة الطلب. حاول مرة أخرى.
  ...
  /// Service is temporarily unavailable. Please try again later. - الخدمة غير متاحة مؤقتًا. حاول مرة أخرى لاحقًا.
  ...
  /// Value is invalid. - قيمة غير صحيحة.
  ...
  /// Value does not match. - القيمة غير مطابقة.
  ...
  /// Value is too large. - القيمة كبيرة جدًا.
  ...
  /// Please select a valid value. - يرجى اختيار قيمة صحيحة.
  ...
  /// You must accept this field. - يجب الموافقة على هذا الحقل.
