...
class AppReactiveDropdownField<T> extends StatefulWidget {
  ...
  factory AppReactiveDropdownField.bottomSheetWithSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
    ...
    return AppReactiveDropdownField<T>.bottomSheet(
      key: key,
      formControlName: formControlName,
      formGroup: formGroup,
      options: options,
  ...
  factory AppReactiveDropdownField.bottomSheetWithoutSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
  ...
  factory AppReactiveDropdownField.dialogWithSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
    ...
    return AppReactiveDropdownField<T>.dialog(
      key: key,
      formControlName: formControlName,
      formGroup: formGroup,
      options: options,
  ...
  factory AppReactiveDropdownField.dialogWithoutSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
  ...
  factory AppReactiveDropdownField.menuWithSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
    ...
    return AppReactiveDropdownField<T>.menu(
      key: key,
      formControlName: formControlName,
      formGroup: formGroup,
      options: options,
  ...
  factory AppReactiveDropdownField.menuWithoutSearch({
    Key? key,
    required String formControlName,
    FormGroup? formGroup,
    required List<AppDropdownOption<T>> options,
